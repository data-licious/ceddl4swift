...
/// CEDDL4Swift is a Swift Framework, with a fluent API, for creating a Data Layer
...
/// The complete CEDDL specification can be found at
...
///		  }
///
/// The CEDDL4Swift code to generate this Data Layer:
///
...
public class DigitalData: NSObject, JSONProtocol {
    ...
    /// - Parameter pID: A unique identifier for a page or
